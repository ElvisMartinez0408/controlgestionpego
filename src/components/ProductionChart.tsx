...
export function ProductionChart() {
  const { getMonthlyStats, getMonthlyProductBreakdown, loading } = useProduction();
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card p-4 text-center glow-orange">
        ...
        <p className="text-sm text-muted-foreground">unidades producidas</p>
      </div>

      <div className="glass-card p-6">
        <h3 className="font-semibold text-foreground mb-4">Producción Diaria</h3>
        {filteredDaily.length > 0 ? (
          ...
          <div className="h-[350px] flex items-center justify-center text-muted-foreground">No hay datos de producción para este mes</div>
        )}
      </div>
