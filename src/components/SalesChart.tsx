...
export function SalesChart() {
  const { getMonthlyStats, getMonthlyProductBreakdown, loading } = useSales();
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card p-6">
        ...
        {filteredDaily.length > 0 ? (
          ...
          <div className="h-[350px] flex items-center justify-center text-muted-foreground">No hay datos de ventas para este mes</div>
        )}
      </div>
